...
export async function onRequestPost({
  ...
  try {
    ...
    /*
      TBT-style compatibility:
      accept either "baseballs"
      or "baseballNumbers"
    */
    ...
    */
    ...
    const teams =
      await supabaseGet(
        ...
        "teams" +
        "?team_key=eq.coral-springs-clippers-cooperstown" +
      ...
      return json(
        {
          ...
          error:
            "Coral Springs Clippers team not found.",
        },
        404
      );
    }
    ...
    */
    ...
    params.set(
      ...
      `Coral Springs Clippers - ${player.player_name}`
    );
