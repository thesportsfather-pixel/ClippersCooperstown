...
export async function onRequestPost({
  ...
  try {
    ...
    */
    ...
    /*
      Only update the fundraiser
      after Stripe says it is paid.
    */
    ...
    /*
      ...
      This webhook should only process
      Coral Springs Clippers payments.
    */

    if (
      metadata.team_key !==
      "coral-springs-clippers-cooperstown"
    ) {
      return json({
        received: true,
        ignored: true,
    ...
    */
    ...
    /*
      ...
      The Stripe session ID is stored
      so repeated webhook events are
      harmless and traceable.
    */
